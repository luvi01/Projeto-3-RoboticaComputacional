...
public class GraficoMapGuloso {
     ...
     */
    public GraficoMapGuloso(GridMap g){
        this(g, 800, 600    );
    }
     ...
     */
    public GraficoMapGuloso(GridMap g, int width, int height){
        this.map = g;
        this.width = width;
        this.height = height;
    ...
    public static void main(String[] args) {
         ...
         */
        GraficoMapGuloso grafico = new GraficoMapGuloso(map);
        grafico.desenha();
