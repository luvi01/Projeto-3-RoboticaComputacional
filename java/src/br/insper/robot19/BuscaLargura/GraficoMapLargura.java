package br.insper.robot19.BuscaLargura;

import br.insper.robot19.Block;
import br.insper.robot19.BuscaA.BuscaA;
import br.insper.robot19.Canvas;
...
public class GraficoMapLargura {
    GridMap map;
    int width;
    int height;
    Canvas screen;
     ...
     */
    public GraficoMapLargura(GridMap g){
        this(g, 800, 600    );
    }
     ...
     */
    public GraficoMapLargura(GridMap g, int width, int height){
        this.map = g;
        this.width = width;
        this.height = height;
    ...
    public static void main(String[] args) {
         ...
         */
        GraficoMapLargura grafico = new GraficoMapLargura(map);
        grafico.desenha();
